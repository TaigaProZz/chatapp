...
public final class ActivityNewConversationBinding implements ViewBinding {
  ...
  private ActivityNewConversationBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull RecyclerView recyclerViewNewConversation,
  ...
  public static ActivityNewConversationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewConversationBinding((ConstraintLayout) rootView, appBarLayout,
          recyclerViewNewConversation, toolbarArrow, toolbarMain, toolbarUsername);
    }

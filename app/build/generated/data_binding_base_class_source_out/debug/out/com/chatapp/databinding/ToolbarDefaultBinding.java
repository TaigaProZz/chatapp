...
public final class ToolbarDefaultBinding implements ViewBinding {
  ...
  private ToolbarDefaultBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull ImageView toolbarArrow,
  ...
  public static ToolbarDefaultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToolbarDefaultBinding((ConstraintLayout) rootView, appBarLayout, toolbarArrow,
          toolbarMain, toolbarUsername);
    }
